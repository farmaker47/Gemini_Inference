...
Java_com_chatbot_domain_speech2text_WhisperEngine_createEngine(JNIEnv *env,
                                                                         jobject thiz) {
...
Java_com_chatbot_domain_speech2text_WhisperEngine_transcribeFileWithMel(JNIEnv *env,
                                                                                  jobject thiz,
                                                                                  jlong nativePtr,
                                                                                  jstring waveFile,
